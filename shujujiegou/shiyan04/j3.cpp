...
string zhongjiang()
{
    string filePath = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
    filePath += "trans_pool.txt";
    fstream outFile(filePath, std::ios::in | std::ios::out);
    // 查询包括按照高度，按照哈希，全部展示,0,1,2
    if (!outFile)
    {
        return "";
    }
    ...
    outFile.close();
    remove("C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/trans_pool.txt");
...
void delete_trans(string s)
{
    string ts = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
...
void add_trans(string s)
{
    ofstream ss("C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/trans_pool.txt", ios::app);
    ss << s << endl;
    ss.close();
    return;
}

int conflict_block(string bk)
{
    string ts = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
...
string add_block(string s)
{
    ...
    string new_bk = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
    new_bk += to_string(h1);
    new_bk += ".txt";
...
int main()
{
    while (1)
    {
        ...
        if (t < 10) // 中不中!
        {
            ...
            ofstream pp("C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node0/block_message.txt", ios::app);
            pp << s << endl;
        }
        else
        {
            // 查看区块消息
            string blockm = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
            ...
            {
                string message = "C:/Users/Baijy/Desktop/homework/shujujiegou/shiyan4/node1/";
                message += "message.txt";
